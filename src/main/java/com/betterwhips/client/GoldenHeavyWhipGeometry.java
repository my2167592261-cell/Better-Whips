...
final class GoldenHeavyWhipGeometry {
    static final int SEGMENT_COUNT = 50;
    ...
    static final float[] AUTHORED_PIVOT_Z = {
            0.0000F, -3.0000F, -6.0000F, -9.0000F, -12.0000F, -15.0000F, -18.0000F, -21.0000F, -24.0000F, -27.0000F, -30.0000F, -33.0000F, -36.0000F, -39.0000F, -42.0000F, -45.0000F, -48.0000F, -51.0000F, -54.0000F, -57.0000F, -60.0000F, -63.0000F, -66.0000F, -69.0000F, -72.0000F, -75.0000F, -78.0000F, -81.0000F, -84.0000F, -87.0000F, -90.0000F, -93.0000F, -96.0000F, -99.0000F, -102.0000F, -105.0000F, -108.0000F, -111.0000F, -114.0000F, -117.0000F, -120.0000F, -123.0000F, -126.0000F, -129.0000F, -132.0000F, -135.0000F, -138.0000F, -141.0000F, -144.0000F, -147.0000F, -150.0000F
    };
    ...
    private static final String MODEL_RESOURCE =
            "/assets/better_whips/models/entity/golden_heavy_whip.bbmodel";
    static final GoldenHeavyWhipGeometry INSTANCE = load();

    private final List<CubeGeometry> handle;
    private final List<List<CubeGeometry>> segments;
    private final List<CubeGeometry> tip;

    private GoldenHeavyWhipGeometry(List<CubeGeometry> handle,
    ...
    private static GoldenHeavyWhipGeometry load() {
        try (var stream = GoldenHeavyWhipGeometry.class.getResourceAsStream(MODEL_RESOURCE)) {
            if (stream == null) {
                throw new IllegalStateException("Missing Golden Heavy Whip model: " + MODEL_RESOURCE);
            }
            ...
            return new GoldenHeavyWhipGeometry(List.copyOf(handle), List.copyOf(immutableSegments), List.copyOf(tip));
        } catch (Exception exception) {
            throw new IllegalStateException("Failed to load Golden Heavy Whip Blockbench geometry",
                    exception);
        }
    }
