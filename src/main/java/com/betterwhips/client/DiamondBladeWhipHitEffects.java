...
public final class DiamondBladeWhipHitEffects {
    ...
    private DiamondBladeWhipHitEffects() {
    }
    ...
    private static void drawExplosion(
        ...
        int outerR = event.magicMirror ? (glowPass ? 194 : 166) : (glowPass ? 118 : 82);
        int outerG = event.magicMirror ? (glowPass ? 118 : 82) : (glowPass ? 214 : 184);
        int outerB = 255;
        int coreR = event.magicMirror ? 248 : 242;
        int coreG = event.magicMirror ? 220 : 249;
        int coreB = 255;
